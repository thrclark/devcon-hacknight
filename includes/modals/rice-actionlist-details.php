...
<div class="modal fade" id="actionlist-details" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                      <h4 class="pull-left"> Routing </h4>
                      <a href="#" class="pull-right"> View Full Route Log </a>
                      <div class="row">
                        <div class="col-md-12">
